...
if (isset($_POST['tglMasuk'])) {
    ...
    if($tanggal_masuk == null){
        $error_message_tanggal = "TANGGAL TIDAK BOLEH KOSONG DAN TIDAK BOLEH MELEBIHI TANGGAL KELUAR!";
        $isTrue = false;
    }
...
if (isset($_POST['gelar'])) {
    ...
    && strcmp($gelar_lowercase, 's1') 
    && strcmp($gelar_lowercase, 'd3')
    && strcmp($gelar_lowercase, 'd4')
    && strcmp($gelar_lowercase, 's2')
    && strcmp($gelar_lowercase, 's3')) || strlen($gelar_lowercase) < 1){
