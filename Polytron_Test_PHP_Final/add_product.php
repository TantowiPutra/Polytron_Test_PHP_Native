...
<script>
    const item_code = []
    <?php while($data = mysqli_fetch_array($execute_query)) { ?>
...
<h1 class="text-align-center mb-4">Polytron Product Stock Management System</h1>
    ...
    <div style="display: flex; justify-content: space-between; max-width: 60%; margin: auto;">
        <a style="text-decoration: none;" href="dashboard.php"><button class="btn-yellow" style="padding: 10px;">DASHBOARD</button></a>
    ...
    <form action="validate_barang.php" method="POST" data-aos="fade-up" data-aos-duration="1800">
        <div style="
            ...
            padding: 20px;
        " class="shadow card"> 
        <h2 class="text-align-center">Produk Baru</h2>
        <?php if(isset($_SESSION['isInvalid'])) { ?>
            <h5 class="text 
                <?php 
                    if(isset($_SESSION['isTrue'])){
                        if($_SESSION['isTrue'] == "T"){
                            echo "text-success";
                        }else if($_SESSION['isTrue'] == "F"){
                            echo "text-danger";
                        }else{
                            echo "text-warning";
                        }
        ...
        <table style="border: none;" cellpadding="20px">
            <tr>
                ...
                <td>:</td>
                <td>
                    <input type="text" name="item_code" id="item_code" pattern="[Pp][Ss]-.{1,}" required style="text-transform:uppercase"
                    <?php
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <input type="text" name="item_name" id="item_name" required minlength="3" style="text-transform:uppercase"
                    <?php
